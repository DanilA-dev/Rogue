...
namespace D_Dev.UtilScripts.DamagableSystem
{
    ...
    public class DamageInfo
    {
        ...
        [field: SerializeReference] public bool UseForceOnGetDamage { get; set; }
        [field: SerializeReference, ShowIf(nameof(UseForceOnGetDamage))] public ForceMode ForceMode { get; set; }
        [field: SerializeReference, ShowIf(nameof(UseForceOnGetDamage))] public Vector3 ForceDirectionOffset { get; set; }
